        ...
        do{
                ...
                if (choice.equals(PURCHASE_MENU_OPTION_FEED_MONEY)) {
                    ...
                    if (choice.equals("Feed Money")) {
                        ...
                        message = message + " " + purchase.getCurrentBalance();
                        Logger logFile = new Logger("Log.txt");
                        logFile.write (message);
                        System.out.println("\nCurrent Money Provided: " + purchase.getCurrentBalance());
                    }
                    ...
                    for (Item item : vendinglist) {
                        if (item.getSlot().equalsIgnoreCase(selectionID)) {
                            ...
                            if (isEnoughMoney) {
                                System.out.println("Dispensing: " + selectionID + " " + item.getName() + " " + item.getPrice());
